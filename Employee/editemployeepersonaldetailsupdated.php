...
$fingerprint = $ipAddress.$user_agent;
 ...
 if (isset($_POST['firstname'])) {
	...
	$loanssqlA = "UPDATE `employeepersonaldetailsupdated` SET `staffkey` = '$staffkey', `staff_id` = '$staff_id', `firstname` = '$firstname', `lastname` = '$lastname', `gender` = '$gender', `dateofbirth` = '$dateofbirth', `placeofbirth` = '$placeofbirth', `hometown` = '$hometown', `contactnumber` = '$contactnumber', `residentialaddress` = '$residentialaddress', `postaladdress` = '$postaladdress', `ssnitnumber` = '$ssnitnumber', `privatemail` = '$privatemail', `facebook` = '$facebook', `twitter` = '$twitter', `maritalstatus` = '$maritalstatus', `Spousename` = '$Spousename', `Marriagedate` = '$Marriagedate', `Numberofchildren` = '$Numberofchildren', `photo` = '$photo', `user_id` = '$user_id', `presbytery` = '$presbytery', `profession` = '$profession', `skills` = '$skills', `createddate` = '$createddate', `department` = '$department', `streetname` = '$streetname', `nationality` = '$nationality', `station` = '$station', `countryofwork` = '$countryofwork', `institution` = '$institution', `staff_status` = '$staff_status', `stafftype` = '$stafftype', `datetaken` = '$datetaken', `corporateemail` = '$corporateemail', `fathername` = '$fathername', `mothername` = '$mothername', `nextofkingname` = '$nextofkingname', `nextofkingcontact` = '$nextofkingcontact', `spouseaddress` = '$spouseaddress', `spousecontactnumber` = '$spousecontactnumber', `emergencycontactpersonname` = '$emergencycontactpersonname', `emergencynumber` = '$emergencynumber', `position` = '$position', `category` = '$category', `confirmed` = '$confirmed', `retirementdate` = '$retirementdate', `ssfretirementdate` = '$ssfretirementdate', `datemodified` = '$datemodified', `modifiedby` = '$modifiedby', `staff_age` = '$staff_age', `moderatorga` = '$moderatorga', `clerkga` = '$clerkga', `preschair` = '$preschair', `presclerk` = '$presclerk', `recordupdated` = '$recordupdated', `staffunit` = '$staffunit', `qrcode` = '$qrcode', `barcode` = '$barcode', `barcodenumber` = '$barcodenumber', `datecommissioned` = '$datecommissioned', `dateordained` = '$dateordained', `staffgroup` = '$staffgroup', `ghanacard` = '$ghanacard', `gpsaddress` = '$gpsaddress', `department_id` = '$department_id', `unit_id` = '$unit_id' WHERE `employeepersonaldetailsupdated`.`id` = '$id'";
